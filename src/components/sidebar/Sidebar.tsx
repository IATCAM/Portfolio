...
function Sidebar() {
  ...
  const [topPosition, setTopPosition] = useState(192); // مقدار اولیه

  useEffect(() => {
    const handleScroll = () => {
      if (window.scrollY > 200) {
        setTopPosition(64); // وقتی اسکرول بیشتر از 200 شد، المنت را بالا ببریم
      } else {
        setTopPosition(192); // مقدار اولیه
      }
    };
    ...
    const sidebar = [
        {
            icon: <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                    <path fillRule="evenodd" clipRule="evenodd" d="M3 2C2.44772 2 2 2.44772 2 3V10C2 10.5523 2.44772 11 3 11H10C10.5523 11 11 10.5523 11 10V3C11 2.44772 10.5523 2 10 2H3ZM4 9V4H9V9H4Z" fill="white"/>
                    <path fillRule="evenodd" clipRule="evenodd" d="M14 2C13.4477 2 13 2.44772 13 3V10C13 10.5523 13.4477 11 14 11H21C21.5523 11 22 10.5523 22 10V3C22 2.44772 21.5523 2 21 2H14ZM15 9V4H20V9H15Z" fill="white"/>
                    <path fillRule="evenodd" clipRule="evenodd" d="M13 14C13 13.4477 13.4477 13 14 13H21C21.5523 13 22 13.4477 22 14V21C22 21.5523 21.5523 22 21 22H14C13.4477 22 13 21.5523 13 21V14ZM15 15V20H20V15H15Z" fill="white"/>
                    <path fillRule="evenodd" clipRule="evenodd" d="M3 13C2.44772 13 2 13.4477 2 14V21C2 21.5523 2.44772 22 3 22H10C10.5523 22 11 21.5523 11 21V14C11 13.4477 10.5523 13 10 13H3ZM4 20V15H9V20H4Z" fill="white"/>
                  </svg>,
            link: "/"
        },
        {
            icon: <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                    <path fillRule="evenodd" clipRule="evenodd" d="M12 2C9.23858 2 7 4.23858 7 7C7 9.76142 9.23858 12 12 12C14.7614 12 17 9.76142 17 7C17 4.23858 14.7614 2 12 2ZM9 7C9 5.34315 10.3431 4 12 4C13.6569 4 15 5.34315 15 7C15 8.65685 13.6569 10 12 10C10.3431 10 9 8.65685 9 7Z" fill="white"/>
  ...
  return (
    <div>
      <ul className="h-[23.5rem] w-16 rounded-[2.5rem] bg-bg2 fixed top-[14.62rem] border border-white left-16 hidden xl:flex flex-col items-center justify-around gap-6 px-3 py-2" style={{top:`${topPosition}px` , transition: "0.5s ease"}}>
        {
            sidebar.map(({link , icon})=>(
                <li key={link} >

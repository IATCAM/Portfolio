      ...
      <form onSubmit={handleSubmit}>
        <div className="mx-auto">
          ...
          <div className="w-[18.35rem] flex flex-col mx-auto xl:w-[30rem]">
            ...
            <button
              type="submit"
              className="bg-brand1 py-4 px-8 flex items-center justify-between Button-U rounded-4xl cursor-pointer text-bg1 xl:w-[14.62rem] xl:mx-auto transition-color border-2 border-brand1 duration-300 hover:bg-bg1 hover:text-white hover:border-2 hover:border-brand1"
            >
              Send Message
              <span>
                <svg className="fill-[#292F36]"
                  xmlns="http://www.w3.org/2000/svg"
                  width="24"
                  height="24"
                  viewBox="0 0 24 24"
